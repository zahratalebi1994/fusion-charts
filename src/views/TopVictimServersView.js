...
import TopVictimServers from "../components/TopVictimServers";
import NavSidebar from "../components/sidebar/NavSidebar";
import DatePicker from "react-datepicker";

class TopVictimServersView extends React.Component{
    state = {
        loading : true,
        attacks : null,
        startDate: null,
                    ...
                    <Grid>
                        <Grid.Row className="p-2">
                            ...
                            <Grid.Column width={12}>
                                <Card fluid raised>
                                    <Card.Content>
                                        <Card.Header>Top Victim Servers</Card.Header>
                                    </Card.Content>
                                    <Card.Content>
                                        <div>
                                            <label>from: </label>
...
export default TopVictimServersView;